...
const val YOUTUBE_VIDEO_ID = "EFJ7kDva7JE"
const val YOUTUBE_PLAYLIST = "RDEFJ7kDva7JE"
...
class YoutubeActivity : YouTubeBaseActivity(), YouTubePlayer.OnInitializedListener {
    ...
    private val playerStateChangeListener = object: YouTubePlayer.PlayerStateChangeListener {
        override fun onAdStarted() {
            Toast.makeText(this@YoutubeActivity, "Click the Ad", Toast.LENGTH_SHORT).show()
        }
        ...
        override fun onVideoEnded() {
            Toast.makeText(this@YoutubeActivity, "You've completed a video.", Toast.LENGTH_SHORT).show()
        }
